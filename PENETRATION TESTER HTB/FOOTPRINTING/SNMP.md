...
```shell-session
hidalg0dd@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```shell-session
hidalg0dd@htb[/htb]$ sudo apt install onesixtyone
hidalg0dd@htb[/htb]$ onesixtyone -c /opt/useful/SecLists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```shell-session
hidalg0dd@htb[/htb]$ sudo apt install braa
hidalg0dd@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntax
hidalg0dd@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
