...
```shell-session
hidalg0dd@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
hidalg0dd@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
hidalg0dd@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
hidalg0dd@htb[/htb]$ mkdir target-NFS
hidalg0dd@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
hidalg0dd@htb[/htb]$ cd target-NFS
hidalg0dd@htb[/htb]$ tree .
